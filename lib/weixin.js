...
class Weixin {
		...
		return new Promise(function (resolve, reject) {
			...
			Request[method](url, arg, ( code, body ) => { 
				...
				if ( data = valid( code, body ) ) {
					...
					reject(body.message || body.errMsg || body.baseResponse.errMsg);
				}
	...
	NewSendMsg(userName, toUserName, content, msgSource = '', type = 1) {
		...
		var tpl = { content, type, msgSource };
		var ret = [];
     ...
     */
	SnsComment(wxId, id, toUsername, type = 0, content = '', replyCommnetId = 0) {

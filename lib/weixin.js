...
class Weixin{
     ...
     */
    SendFriendCircle( wxId, type, title = '', contentUrl = '', description = '', content = '', mediaInfos = [], blackList = [], withUserList = []) {
		var api = 'FriendCircle/SendFriendCircle';		
		var ret = { wxId, type, title, content, contentUrl, description, mediaInfos, blackList, withUserList };
        return this.post( api, ret );
    }
    ...
    Img( wxId, toWxIds, aesKey,  $cDNMidImgSize = 0, cDNMidImgUrl = '',  $cDNThumbImgSize = 0, cDNThumbImgUrl = '', cDNBigImgUrl = '',  $cDNBigImgSize = 0)
     {
        ...
        var ret = { toWxIds, aesKey, cDNMidImgSize, cDNMidImgUrl, cDNThumbImgSize, cDNThumbImgUrl, cDNBigImgUrl, cDNBigImgSize, wxId }; 
        return this.post( api, ret );
    }

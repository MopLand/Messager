...
class Activity {
	...
	*/
	...
	static randomTbc(text) {
		...
		let end = ['￥','¥','€','₰','₲','《','$','₤','₪','¢','₵','₳','₴'];
		let word = [
			'0.领卷下dan', '0-领巻链接', '0.0抢Gòμ链接', '0-tα0密令', '0槍gòμ地址',
			...
			'0立即槍gòu', '0-马上去搶', '0&快mǎi呀', '0:速度槍', '0限时忒恵', '0~领巻立減', '0-拣漏冻',
			'0:神價速搶', '0.内部價', '0@超值購', '0&实恵購', '0.超低價', '0:去(ταō·bαó)購',
			'0-到(ταō+bαó)價', '0@去<ταō~bαó>mǎi', '0:狠划算吖', '0~陋洞價', '0.底价䓆扣',
			'0-去(ταō·bαó)槍', '0.立享䓆扣', '0-省錢Gòu', '0@省錢立減', '0.限时䓆筘'
		];
